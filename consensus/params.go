...
const (
	...
	defaultMaxMass       uint64 = 210000000
	defaultMinRelayTxFee uint64 = 10000

	defaultSubsidyHalvingInterval uint64 = 4096
	defaultBaseSubsidy            uint64 = 1024 * MaxwellPerMass
	defaultMinHalvedSubsidy       uint64 = 6250000

	defaultMinFrozenPeriod uint64 = 122880
	defaultMinStakingValue uint64 = 4096 * MaxwellPerMass

	Massip1Activation uint64 = 1000
